        ...
        <div class="container-fluid">
            ...
            <?php include('dashboard_slidebar.php'); ?>
				...
				<?php	
                 ...
                 ?>	 
                        <div id="block_bg" class="block" style="margin-left:-390px; width:1050px">
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
				...
				<td width="100px">
				<a rel="tooltip"  title="View Students Approved Chapters" id="p<?php echo $matricno; ?>" href="adminviewstudents_chapters2.php<?php echo '?studentId='.$studentId; ?>"  data-toggle="modal" class="btn btn-success">V/Chapters</a>
												</td>
