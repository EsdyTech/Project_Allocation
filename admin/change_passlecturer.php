					  ...
					  <div class="alert alert-success"><i class="icon-info-sign"></i> Please Fill in required details</div>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Lecturer change Password</div>							 
                            </div>
                            <div class="block-content collapse in">
								...
								?>		
								 <div class="container-fluid">
                                    <div class="row-fluid">
									 <!----------------------form------------------->		
								    <form  method="post" id="change_password" action="change_passlecturer.php" class="form-horizontal">
...
<input type="password" id="retype_password" name="retype_password" placeholder="Re-type Password" required/>
		...
		$dev = mysqli_query($con,"select * from lecturer WHERE username='$lectid'")or die(mysqli_error());
...
echo '<script language="javascript">alert("Password does not match!!")</script>';
		...
		$query = mysqli_query($con,"UPDATE lecturer SET password='$new_password' WHERE username='$lectid'")or die(mysqli_error());
