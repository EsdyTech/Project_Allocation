                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							   <div class="muted pull-left"><i class="icon-reorder icon-building"></i> location List</div>                       
								...
								<?php 
								$my_department = mysql_query("select * from course ")or die(mysql_error());
                                ...
                                <div class="span12">
									<form action="delete_department.php" method="post">
									  ...
									  <thead>
										...
										<tbody>
										<?php
										$department_query = mysql_query("select * from course")or die(mysql_error());
										...
										<tr>
											...
											<td><?php echo $department_row['course_title']; ?></td>
