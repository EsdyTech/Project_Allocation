...
mysql_query("update user set username = '$username'  , firstname = '$firstname' , middlename = '$middlename', lastname = '$lastname' where user_id = '$get_id' ")or die(mysql_error());
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname $lastname')")or die(mysql_error());	
?>
<script>
