    ...
    <?php include('lecturer_navbar.php'); ?>
        <div class="container-fluid">
								...
								<form action="reg_students.php" method="post">
                                   ...
                                   <!-- <input type="submit" name="delete"  onClick="return val()" class="btn btn-danger" value="Delete"/> -->
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
						<?php
	                    $device_name_query = mysqli_query($con,"select * from student_topics where studentId = '$studentId' and status='Approved'")or die(mysqli_error());						while($row = mysqli_fetch_array($device_name_query)){
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
				...
				<td width="100px"><a rel="tooltip"  title="Approve Students Topic" id="p<?php echo $matricno; ?>" href="addChapters.php<?php echo '?studentId='.$studentId; ?>"  data-toggle="modal" class="btn btn-success">Add Chapters</a>
												</td>
