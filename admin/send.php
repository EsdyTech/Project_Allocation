...
for($i=0; $i < $N; $i++)
{
		...
		mysql_query("insert into release_details (item_id, dep_id, release_id,release_status,remarks) values ('$id[$i]','$dep_id','$release_id','pending',' / Brand new')")or die(mysql_error());
		...
		item_id='$id[$i]',
		item_status ='In-Used' where item_id='$id[$i]' ")or die(mysql_error());
}
