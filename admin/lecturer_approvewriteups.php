...
<?php $projWriteupId = $_GET['projWriteupId']; ?>
    ...
    <?php include('lecturer_navbar.php'); ?>
        <div class="container-fluid">
            ...
            <?php include('lecturer_slidebar.php'); ?>
				<div class="span3" id="adduser" style="margin-right:25px;">
				<?php include('lecturer_updatewriteups.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
				...
				<?php	
                 ...
                 ?>	 
                        <div id="block_bg" class="block" style="width:1640px; margin-left:-110px">
                            ...
                            <div class="block-content collapse in" style="margin-left:10px; width:1620px">
                                <div class="span12">
