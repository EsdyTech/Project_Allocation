                            ...
                            <div class="block-content collapse in">
									...
									<?php include('modal_delete.php'); ?>
										<thead>
                                          ...
                                          <th><font color="#0000FF">s/n</font></th>
												...
												<th><font color="#0000FF">view</font></th>
										   </tr>
										</thead>
										<tbody>
									<?php
								...
								while($row = mysql_fetch_array($device_name_query)){
									...
									?>
												...
												<td width="75">
												<a rel="tooltip"  title="View Course" id="v<?php echo $course_code; ?>"  href="student_downass.php<?php echo '?course_code=' . $course_code; ?>" class="btn btn-info">&nbsp;<i class="icon-file-alt icon-large"></i>&nbsp;<?php //echo $row['subject_id']; ?></a>
												</td>
