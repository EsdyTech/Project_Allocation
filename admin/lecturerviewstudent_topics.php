    ...
    <?php include('lecturer_navbar.php'); ?>
        <div class="container-fluid">
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
				...
				<td width="100px">
				<a rel="tooltip"  title="Approve Students Topic" id="p<?php echo $matricno; ?>" href="lecturerviewstudent_topics2.php<?php echo '?studentId='.$studentId; ?>"  data-toggle="modal" class="btn btn-success">View Topics</a>
												</td>
