    ...
    <?php include('lecturer_navbar.php'); ?>
        <div class="container-fluid">
            ...
            <?php include('lecturer_slidebar.php'); ?>
				...
				<?php include('lecturer_updatestudenttopic.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
				...
				<?php	
	             $count_dev_name=mysqli_query($con,"select * from student_topics where studentId = '$studentId'");
	             $count = mysqli_num_rows($count_dev_name);
                 ?>	 
                        <div id="block_bg" class="block" style="width:1060px; margin-left:-80px">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-folder-open-alt"></i> Student Topics List</div>
								<div class="muted pull-right">
								Number of Student Topics: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
