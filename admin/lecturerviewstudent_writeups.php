        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
                 ...
                 ?>	 
                        <div id="block_bg" class="block" style="margin-left:-350px; width:1040px">
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
				...
				<td width="120px">
				<a rel="tooltip"  title="Approve Students Topic" id="p<?php echo $matricno; ?>" href="lecturerviewstudent_writeups2.php<?php echo '?studentId='.$studentId; ?>"  data-toggle="modal" class="btn btn-success">View Writeup</a>
												</td>
