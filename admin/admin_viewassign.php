        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
                 ...
                 ?>	 
                        <div id="block_bg" class="block" style="width:1400px; margin-left:-480px">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-folder-open-alt"></i> Course(s) Assigned List</div>
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
												...
												<td width="75">
												<a rel="tooltip"  title="Edit Assign courses" id="p<?php echo $id; ?>" href="edit_employee.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
