    ...
    <?php include('navbar.php'); ?>
        <div class="container-fluid">
			...
			<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $matricno; ?>">
				...
				<td width="100px">
				<a rel="tooltip"  title="View Students selected Topic" id="p<?php echo $matricno; ?>" href="adminviewstudents_topics2.php<?php echo '?studentId='.$studentId; ?>"  data-toggle="modal" class="btn btn-success">View Topics</a>
												</td>
