...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Nov 20, 2020 at 10:04 AM
...
DROP TABLE IF EXISTS `group_name_table`;
...
(12, 'hhddhh', 'hshsaaggagga', 'Male', 'hoeoro', 'uploads/lecturer.jpg', '090399303', 'password', 'Full Time', 'Activated');
...
DROP TABLE IF EXISTS `project_chapters`;
CREATE TABLE IF NOT EXISTS `project_chapters` (
  `projChapId` int(10) NOT NULL AUTO_INCREMENT,
...
(5, 'HCSF/15/0009', 2, 'ola', 'Chapter Two', 'Activated', 'Completed', '2019-07-17', '2019-07-17', '2019-07-09');
...
DROP TABLE IF EXISTS `project_writeups`;
CREATE TABLE IF NOT EXISTS `project_writeups` (
  `projWriteupId` int(10) NOT NULL AUTO_INCREMENT,
  `studentId` varchar(255) NOT NULL,
  `lecturerId` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `research_topic_table`;
...
INSERT INTO `students` (`id`, `surname`, `firstname`, `othername`, `matricno`, `password`, `sex`, `pic`, `level`, `isAssigned`, `status`) VALUES
(3, 'omopariola', 'kayode', 'ezekiel', 'HCSF/15/0009', 'kay', 'Male', 'uploads/IMG_0138.PNG', 'HND2', '1', 'Activated'),
(5, 'Omolodun', 'Gbolahan', 'Daniel', 'NCSF/15/0008', 'dan', 'Male', 'uploads/student.jpg', 'ND2', '0', 'Activated'),
(9, 'omopariola', 'tolu', 'josh', 'NCSF/15/0032', 'tolu', 'Male', 'uploads/student.jpg', 'ND2', '0', 'Activated'),
(12, 'BAMIDELE', 'MOBOLA', 'ZAINAB', 'HCSF/15/0001', 'EW2OS', 'Female', 'uploads/student.jpg', 'HND1', '0', 'Activated'),
(18, 'GAMBARI', 'KAZEEM', 'OLAYIWOLA', 'HCSF/15/0003', 'akanni4real', 'Male', 'uploads/20.jpg', 'HND2', '0', 'Activated'),
(19, 'SALISU', 'RASAQ', 'ADEKUNLE', 'HCSF/15/0032', 'vuShI', 'Male', 'uploads/student.jpg', 'HND2', '0', 'Activated');
...
CREATE TABLE IF NOT EXISTS `student_topics` (
  `stdTopicId` int(10) NOT NULL AUTO_INCREMENT,
  `studentId` varchar(50) NOT NULL,
...
(11, 'HCSF/15/0009', 2, 'Approved', 'proposals/402.pdf', 'Go Ahead', '2019-07-09', '2020-09-20'),
